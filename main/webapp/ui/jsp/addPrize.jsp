...
<h1 align="center">Ajouter une récompense</h1>
...
<c:choose>
    ...
    <div class="alert alert-warning" role="alert">
        <p class="error"> Nom et  niveau de la récompense obligatoires</p>
        <br />
    </div>
    </c:when>
    <c:when test="${param.message==2}">
    <div class="alert alert-success" role="alert">
        <p class="success"> La nouvelle récompense a été ajoutée avec succès</p>
        <br />
    </div>
    </c:when>
    <c:otherwise>
...
<form:form  method="POST" action="/levelup/newPrize" modelAttribute="prize">
    ...
    <div class="form-group">
        ...
        <form:select class="form-control" path="level_id" id="levels" >
        </form:select>
    </div>
