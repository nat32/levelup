...
<h1 align="center">Récompenses à gagner</h1>
...
<c:choose>
    ...
    <c:when test="${param.message==4}">
            <div class="alert alert-success" role="alert">
        <p class="success">   La récompense a été modifiée avec succèss </p>
            </div>
    </c:when>
...
<h3>Voici la liste de vos récompenses restant à gagner :</h3>
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <table>
                    ...
                    <tr>
                        <td>Nom :</td>
                        <td>Accessible au niveau :</td>
                        <td>Pour atteindre ce niveau il faut gagner :</td>
                        <td>Modifier</td>
                        <td>Supprimer</td>
                    </tr>
                    </thead>
                ...
                <c:forEach var="prize" items="${prizes}">
                    <tr>
                        ...
                        <td>  ${prize.level_points} points</td>
                        <td> <a href="/levelup/modifyPrize/${prize.id}/${user_id}" ><i class="fas fa-edit"> </i> </a>  </td>
                        <td> <a href="/levelup/deletePrize/${prize.id}/${user_id}/showPrizes" ><i class="far fa-trash-alt"></i> </a>  </td>
                    </tr>
                </c:forEach>
